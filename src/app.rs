...
fn help_text() -> String {
    [
        ...
        "/review <repo-path> - Review uncommitted changes in a repo",
        "/review <repo-path> base <branch> - Review changes against a base branch",
        "/review <repo-path> commit <sha> - Review a commit",
        "/review <repo-path> <prompt> - Run a custom review prompt in a repo",
...
fn review_help_text() -> String {
    [
        "Usage:",
        "/review <repo-path>",
        "/review <repo-path> base <branch>",
        "/review <repo-path> commit <sha>",
        "/review <repo-path> <custom review prompt>",
        "",
        "Examples:",
        "/review auto-drive",
        "/review auto-drive base main",
        "/review auto-drive commit abc123",
        "/review auto-drive focus on bugs, regressions, and missing tests",
        "",
        "Notes:",
        "repo-path is absolute or relative to the bot workdir.",
        "Codex CLI does not allow extra notes together with base/commit/uncommitted.",
    ]
    .join("\n")
}
