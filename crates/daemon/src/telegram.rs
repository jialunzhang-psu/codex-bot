...
impl TelegramClient {
    ...
    #[cfg(test)]
    pub(crate) fn with_api_base(api_base: impl Into<String>) -> Result<Self> {
        Ok(Self {
            http: Client::builder()
                .user_agent(concat!(
                    env!("CARGO_PKG_NAME"),
    ...
    pub async fn send_message(
        ...
        self.send_message_formatted(chat_id, text, reply_to_message_id, None)
            .await
    }
    ...
    pub async fn edit_message(&self, chat_id: i64, message_id: i64, text: &str) -> Result<()> {
        self.edit_message_formatted(chat_id, message_id, text, None)
            .await
    }

    pub async fn edit_message_formatted(
        &self,
        chat_id: i64,
        message_id: i64,
        text: &str,
